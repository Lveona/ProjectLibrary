...
//        property var width: root.width
        ...
        vertexShader: "qrc:/eco/qml/ADAS/adas3d/Roads.vsh"
        fragmentShader: "qrc:/eco/qml/ADAS/adas3d/Roads.fsh"
        ...
        property var singleDashOfLaneWithLumination: Image {
            source: "qrc:/eco/qml/ADAS/singleDashOfLaneWithLumination.png"
            width: sourceSize.width
            height: sourceSize.height
            visible: false
        }
        property var singleDashOfLaneWithoutLumination: Image {
            source: "qrc:/eco/qml/ADAS/singleDashOfLaneWithoutLumination.png"
            width: sourceSize.width
            height: sourceSize.height
            visible: false
        }
