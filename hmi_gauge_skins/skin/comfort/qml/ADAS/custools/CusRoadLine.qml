...
Item {
    ...
    ShaderEffect {
        ...
        property real digitSpeed: root.digitSpeed
...
//        property var width: root.width
        ...
        vertexShader: "qrc:/comfort/qml/ADAS/adas3d/Roads.vsh"
        fragmentShader: "qrc:/comfort/qml/ADAS/adas3d/Roads.fsh"
        ...
        property var singleDashOfLaneWithLumination: Image {
            source: "qrc:/comfort/qml/ADAS/singleDashOfLaneWithLumination.png"
            width: sourceSize.width
            height: sourceSize.height
            visible: false
        }
        property var singleDashOfLaneWithoutLumination: Image {
            source: "qrc:/comfort/qml/ADAS/singleDashOfLaneWithoutLumination.png"
            width: sourceSize.width
            height: sourceSize.height
            visible: false
        }
