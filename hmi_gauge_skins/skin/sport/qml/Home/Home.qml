...
Item {
    ...
    SequentialAnimation {
        ...
        NumberAnimation {target: home; duration: 500; properties: "opacity"; from: 0.0; to: 1.0;}
        onStopped: {            
    ...
    SequentialAnimation {
        id:homeAllAnim_End
        NumberAnimation {target: home; duration: 500; properties: "opacity"; from: 1.0; to: 0.0;}
        onStopped: {
...
//                NumberAnimation {target: lineImg; properties: "";from:1.0;to:0.0;duration: 1000}
//            }
