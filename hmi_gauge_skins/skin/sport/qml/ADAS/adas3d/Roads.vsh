...
//    }
    ...
    if(qt_Vertex.y < 44)    // 下边线
    {
        tempY = 0.0;
    }
    else if(qt_Vertex.y < 100)   //中心位置
    {
        tempY = aMax - (100 - qt_Vertex.y) * (100 - qt_Vertex.y);
    }
    else if(qt_Vertex.y < 300)    // 上边线
    {
        tempY = aMax - (qt_Vertex.y - 100) * (qt_Vertex.y - 100);
    }
    else
    {
        tempY = 0.0;
