...
Model {
    ...
    property bool left_Right_Anim_Running: left_Right_Anim.running
...
//        loops: Animation.Infinite
        //并行动画
        ParallelAnimation{
            PropertyAnimation{target: path3; properties: "y"; from: 0; to: fcwImg.sourceSize.height; duration: 500; }
            PropertyAnimation{target: path4; properties: "y"; from: 0; to: fcwImg.sourceSize.height; duration: 500; }
        }
    }
...
//    onAdasAnim_Left_RightChanged: {
//        if(1 === adasAnim_Left_Right && left_Right_Anim.running === false)
//        {
//            left_Right_Anim.restart()
//        }
//    }
