...
Item {
    ...
    Item{
        ...
        SequentialAnimation{
            id:numberAnim_Start
            NumberAnimation { target: numItem; properties: "opacity"; duration: 1000; from: 0.0; to: 1.0}
            onStopped: {
                handleEnterAnimOver();
            }
        }
        ...
        SequentialAnimation{
            id:numberAnim_End
            NumberAnimation { target: numItem; properties: "opacity"; duration: 1000; from: 1.0; to: 0.0}
...
/**********************************************************************************************************************/
    ...
    SequentialAnimation{
        ...
        ParallelAnimation{
            PropertyAnimation{target: speedDiaVisibleAreaimg; property: "x"; from: speedDiaVisibleAreaimg.width; to: 0; duration: 1000; easing.type: Easing.Linear;}
        }
    }
    ...
    SequentialAnimation{
        id: speedDiaAnim_End
        ParallelAnimation{
            PropertyAnimation{target: speedDiaVisibleAreaimg; property: "x"; from: 0; to: speedDiaVisibleAreaimg.width; duration: 1000; easing.type: Easing.Linear;}
        }
    }
...
/** *******************************************************************************************************************/
    ...
    Item{
        ...
        Image { // 功率底图
            ...
            source: ("pic_HMI_classic_default_powerdial_base.png");
            Image{
                x: 11
                y: 36
        ...
        CustomShape{//功率 -100 ~ 0
            ...
            headlightSrc: "../Gauge/pic_HMI_classic_default_powerdial_highlightgreen.png"
            headlightX: 1238
            headlightY: 610
        ...
        CustomShape{//功率 0 ~ 100
            ...
            headlightSrc: "../Gauge/pic_HMI_classic_default_powerdial_highlight1.png"
            curValue: powerAnim >= 0 ? powerAnim: 0
            headlightX: 1447
            headlightY: 439
            maxValue: 100
    ...
    SequentialAnimation{
        ...
        ParallelAnimation{
            PropertyAnimation{target: powerDiaVisibleAreaimg; property: "x"; from: 1920 - powerDiaVisibleAreaimg.width * 2; to: 1920 - powerDiaVisibleAreaimg.width; duration: 1000; easing.type: Easing.Linear;}
        }
    }
    ...
    SequentialAnimation{
        id: powerDiaAnim_End
        ParallelAnimation{
            PropertyAnimation{target: powerDiaVisibleAreaimg; property: "x"; from: 1920 - powerDiaVisibleAreaimg.width; to: 1920 - powerDiaVisibleAreaimg.width * 2; duration: 1000; easing.type: Easing.Linear;}
        }
    }
